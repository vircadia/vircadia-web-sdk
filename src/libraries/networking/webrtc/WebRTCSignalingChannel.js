...
class WebRTCSignalingChannel {
    ...
    /*@devdoc
     * Sets a function to be called upon the occurrence of an <code>"open"</code>, <code>"message"</code>, <code>"error"</code>,
     * or <code>"close"</code> event.
    ...
    /*@devdoc
     * The signaling messages are sent and received as JSON objects, with either a WebRTC signaling <code>data</code> payload or
     * an </code>echo</code> request. The domain server or assignment client bounces echo requests back for testing purposes.
