...
import GrabPropertyGroup, { GrabProperties } from "../../entities/GrabPropertyGroup";
...
const EntityData = new class {
     ...
     *  @property {GrabProperties|undefined} grab - Properties that control how the entity behaves when grabbed.
    ...
    #readEntityDataFromBuffer(data: DataView, pos: number): ParsedData {
        ...
        for (let i = 0; i < numberOfEntities; i++) {
            ...
            const grabSubclassData = GrabPropertyGroup.readEntitySubclassDataFromBuffer(data, dataPosition, propertyFlags);
            dataPosition += grabSubclassData.bytesRead;
            const grab = grabSubclassData.bytesRead > 0 ? grabSubclassData.properties : undefined;
